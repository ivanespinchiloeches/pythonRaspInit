...
# saved as "/home/pi/line_graph-2016-10-22-14-51-20.py"
...
def clamp(value, min_value, max_value):
    ...
    """
    sys.stdout.write("clamp, value= %d min_value= %d  max_value= %d \r"
...
def display_readings(hat):
    ...
    temperature = 7 - round(scale(clamp(hat.temperature,
         *temperature_range), *temperature_range))
    pressure = 7 - round(scale(clamp(hat.pressure,
        *pressure_range), *pressure_range))
    humidity = 7 - round(scale(clamp(hat.humidity,
